    ...
    <nav className={styles.sidebar}>
      ...
      <div className={styles.navItems}>
        ...
        <div onClick={() => {
          ...
          {
            activeComponent === "Posts" ? <strong>Posts</strong> : "Posts"
          }
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "MyPosts" ? <strong>My Posts</strong> : "My Posts"}
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "Notifications" ? <strong>Notifications</strong> : "Notifications"}
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "Messages" ? <strong>Messages</strong> : "Messages"}
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "Bookmarks" ? <strong>Bookmarks</strong> : "Bookmarks"}
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "Profile" ? <strong>Profile</strong> : "Profile"}
        </div>
        ...
        <div onClick={() => {
          ...
          {activeComponent === "More" ? <strong>More</strong> : "More"}
        </div>
